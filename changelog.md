...
# 1.0.0-alpha.7
- Fixed TPSBypass, no longer using ram patching.
- Added Showhitbox, Layout, and Trajectory.
- Fixed Framecount.

# 1.0.0-alpha.6
- Tried to actually fix framecounter.
- Rework of TPSBypass (again).
- Framecounter works (kinda).
- Major rewrite to use Astral namespace.
